		...
		GSUcreateDiv( { id: "scalesGraphPadding" },
			GSUcreateDiv( { id: "scalesGraphInn" },
				...
				GSUcreateDiv( { id: "svg-wrap" },
					GSUcreateElement( "svg", { id: "svg", viewBox: "0 0 100 100" },
						GSUcreateElement( "polygon", { id: "polyMajor", points: "50,0 93,25 93,75 75,93 25,93 0,50 25,7" } ),
						GSUcreateElement( "polygon", { id: "polyMinor", points: "50,0 93,25 100,50 75,93 25,93 7,75 7,25" } ),
					)
				),
